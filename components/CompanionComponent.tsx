      ...
      <section className="flex gap-8 max-sm:flex-col">
        ...
        <div className="user-section">
          ...
          <button className="btn-mic" onClick={toggleMicrophone}>
            <Image
              src={isMuted ? "/icons/mic-off.scg" : "/icons/mic-on.svg"}
              alt="mic"
              height={36}
              width={36}
            />
            <p className="max-sm:hidden">
              {isMuted
                ? "Please turn on microphone"
                : "Please turn off microphone"}
            </p>
            <button
              className={cn(
                "rounded-lg py-2 cursor-pointer transition-colors w-80 text-white",
